...
//GET por codigo
router.get("/asignaturas/:COD_ASIGNATURA", (req, res) => {
    try {
...
//Metodo Post
  router.post("/nueva_asignatura", (req, res) => {
    try {
   ...
   //Metodo put
   router.put("/modificar_asignatura", (req, res) => {
    try {
       const {COD_ASIGNATURA,NOMBRE_ASIGNATURA } = req.body;
...
//GET por codigo
router.get("/Jornadas/:COD_JORNADA", (req, res) => {
    try {
  ...
  //Metodo Post
  router.post("/nueva_jornada", (req, res) => {
    try {
   ...
   //Metodo put
   router.put("/modificar_jornada", (req, res) => {
    try {
       const {COD_JORNADA,DESCRIPCION_JOR} = req.body;
...
router.get('/SELanio_academico', (req, res) => { 
...
//GET por codigo
router.get('/SELanio_academico/:COD_ANIO_ACADEMICO', (req, res) => { 
...
router.get('/nivel_academico', (req, res) => { 
    mysqlConnection.query(`Call SP_moduloAcademico('MA_NIVEL_ACADEMICO','SA','1','1','1','null')`, (err, rows) => {
        if (!err) {
            res.status(200).json(rows[0]);
        } else {
            console.log('Se ha producido un error');
...
//GET por codigo
router.get("/nivel_academico/:COD_NIVEL_ACADEMICO", (req, res) => {
    try {
  ...
  router.post("/nuevo_nivel", (req, res) => {
    try {
       const {descripcion} = req.body;
...
//Metodo put
router.put("/modificar_nivel", (req, res) => {
    try {
       const {COD_NIVEL_ACADEMICO,descripcion } = req.body;
...
//GET por codigo
router.get("/Secciones/:COD_SECCIONES", (req, res) => {
    try {
   ...
   router.post("/nueva_seccion", (req, res) => {
    try {
   ...
   router.put("/modificar_seccion", (req, res) => {
    try {
       const {COD_SECCIONES,DESCRIPCION_SECCIONES} = req.body;
